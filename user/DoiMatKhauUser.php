                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" style="pointer-events: none;" placeholder="Tên đăng nhập" name="txtTenDangNhap" required autocomplete="off" value="<?php echo $row['MaSinhVien'] ?>">
